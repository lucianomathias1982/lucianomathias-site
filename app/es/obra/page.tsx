...
const PROJECTS = [
  ...
  },
  {
    ...
    meta: "Dirección · Insula AI",
    desc: "Película de marca dirigida con IA para Clear, de Unilever — patrocinadora oficial de la Copa del Mundo FIFA.",
    id: "wc6uuefUL0Y",
  },
  {
...
const AUTORAIS = [
  {
    ...
    meta: "Dirección · Luciano Mathias · 2026",
    // TODO: sinopsis
    desc: "",
    id: "Ew1L3hLX0wM",
  },
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-100 antialiased">
      ...
      <section className="border-t border-white/5 px-6 py-10">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-10 font-serif text-[2rem] font-light leading-[1.15] sm:text-[2.75rem]">Películas de autor</h2>
          <div className="grid gap-10">
            {AUTORAIS.map((p) => (
              <article key={p.id} className="grid gap-8 md:grid-cols-12 md:items-center">
