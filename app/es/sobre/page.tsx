    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100 antialiased">
      ...
      <section className="px-6 py-10">
        <div className="mx-auto max-w-6xl">
          <p className="mb-8 text-xs font-medium uppercase tracking-[0.3em] text-neutral-500">Trayectoria</p>
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <a href="/es/aifilms" className="group inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-sm font-medium text-black transition hover:bg-neutral-200">
