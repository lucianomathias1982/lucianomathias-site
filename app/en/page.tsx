      ...
      <section className="border-t border-white/5 px-6 py-10">
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 max-w-2xl">
            <p className="text-xs font-medium uppercase tracking-[0.3em] text-neutral-500">Own work</p>
            <h2 className="mt-4 font-serif text-[2rem] font-light leading-[1.15] sm:text-[2.75rem]">Authorial films</h2>
          </div>
          <div className="grid gap-8 md:grid-cols-12 md:items-center">
            ...
            <div className="md:col-span-4">
              <p className="text-xs uppercase tracking-[0.25em] text-neutral-500">Short film</p>
              <h3 className="mt-3 font-serif text-3xl font-light leading-tight">The Invitation</h3>
              <p className="mt-6 text-xs uppercase tracking-widest text-neutral-600">Direction · Luciano Mathias · 2026</p>
              <a
